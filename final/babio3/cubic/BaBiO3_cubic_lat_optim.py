...
def compute_energy(alat, nk, ecut):
    ...
    runpath = Dir(path=os.path.join(os.environ["WORKDIR"], "final-project/final/babio3/cubic/relax/test", dirname))
...
def lattice_scan():
    ...
    """ with open('BaBiO3_lattice_optimization.csv', mode='w', newline='') as file:
