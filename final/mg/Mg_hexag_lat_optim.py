...
def compute_energy(alat, nk, ecut):
    ...
    runpath = Dir(path=os.path.join(os.environ["WORKDIR"], "final-project/final/mg/hexag/scf", dirname))
...
def lattice_scan():
    ...
    with open('Mg_lattice_optimization.csv', mode='w', newline='') as file:
